...
from cache import get_word_to_level_map, get_word_details_map # <-- IMPORT NEW CACHE
...
def update_words():
    ...
    word_details_map = get_word_details_map() # <-- Get the new cache
    ...
    category_performance = report_data.setdefault('category_performance', {}) # <-- Get category tracker
    ...
    for result in results:
        ...
        # --- NEW: Update category performance ---
        ...
        # ... (Volatility and other logic is unchanged) ...
